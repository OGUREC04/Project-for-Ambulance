...
async def msg(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        print(phone,em)
        cursor.execute(
            """INSERT INTO users (Email, Number, Telegram_id) VALUES
                (%s, %s, %s);""",
            (str(em), str(phone), '123',))
...
def main() -> None:
    ...
    application = (
        Application.builder().token("5143376368:AAGZZ3XG9FylgA8TsMOjWVtYQmt504DH0iQ").private_key(
